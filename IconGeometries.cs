...
public static class IconGeometries
{
    ...
    /// <summary>Minimize / compact mode icon</summary>
    public static Geometry MiniModeIcon { get; } = Geometry.Parse(
        "M19,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M19,19H5V5H19V19M7,9H17V7H7M7,13H17V11H7M7,17H13V15H7V17Z");
}
